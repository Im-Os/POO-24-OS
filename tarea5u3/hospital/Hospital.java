...
public class Hospital {
    ...
    ppublic Administrador obtenerAdministradorPorId(String idAdmin) {
        for (Usuario usuario : this.listaUsuarios) {
            if (usuario.getId().equals(idAdmin) && usuario instanceof Administrador) {
    ...
    public void registrarPaciente(Paciente paciente) {
        if (existeEmailUsuario(paciente.getEmail())) {
            System.out.println("El correo electrónico ya está registrado, intente con otro.");
            return;
        }
        if (existeNumeroTelefonoPaciente(paciente.getTelefono())) {
            System.out.println("El número de teléfono ya está registrado, intente con otro.");
            return;
        }
    ...
    public void registrarMedico(Medico medico) {
        if (existeEmailUsuario(medico.getEmail())) {
            System.out.println("El correo electrónico ya está registrado, intente con otro.");
            return;
        }
        if (existeNumeroTelefonoMedico(medico.getTelefono())) {
            System.out.println("El número de teléfono ya está registrado, intente con otro.");
            return;
        }
