...
public class Menu {
   ...
   private void mostrarMenuPaciente(){
        ...
        while(opcion != 12) { // Cambiado a 12 para acomodar la nueva opción de ver información personal
            ...
            switch (opcion) {
                ...
                case 11:
                    ...
                    case 12:
                    mostrarInformacionPersonalAdmin(); // Llamada a la nueva función para mostrar información personal
                    break;
                case 13:
    ...
    private void mostrarInformacionPersonalAdmin() {
        String idAdmin = "admin"; // Asumiendo que el ID del administrador es "admin"
        Administrador admin = hospital.obtenerAdministradorPorId(idAdmin);
        if (admin != null) {
            System.out.println(admin.mostrarDatosAdmin());
        } else {
